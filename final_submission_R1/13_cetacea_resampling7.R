...
#Re-sampling approach no. 7 to more thoroughly investigate underlying patterns of trait evolution
...
#Do results change when extant lineages and filter feeders are excluded and the sample size is the same as for ichthyosaurs?
...
write.csv(aicc.scores, "aicc_cetaceans_fossil_nonfilterfeeders_resampled.csv")
write.csv(akaike.weights, "aw_cetaceans_fossil_nonfilterfeeders_resampled.csv")
write.csv(BM_parameters, "bm_cetaceans_fossil_nonfilterfeeders_resampled.csv")
write.csv(OU_parameters, "OU_cetaceans_fossil_nonfilterfeeders_resampled.csv")
write.csv(EB_parameters, "EB_cetaceans_fossil_nonfilterfeeders_resampled.csv")
write.csv(trend_parameters, "trend_cetaceans_fossil_nonfilterfeeders_resampled.csv")
write.csv(drift_parameters, "drift_cetaceans_fossil_nonfilterfeeders_resampled.csv")

#akaike.weights <- read.csv("aw_cetaceans_fossil_nonfilterfeeders_resampled.csv") #in case one later returns to the model fitting output
...
pdf("Fig_S11_I_Akaike_weights_cetaceans_100_fossil_nonfilterfeeders_resampled.pdf", 8, 6)
